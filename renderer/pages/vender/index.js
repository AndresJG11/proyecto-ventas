...
class index extends Component {
    ...
    constructor(props) {
        ...
        this.state = { productos: [], productSelected: {}, dataSimulada: {} }
    ...
    handleProductChange(e, productSelected) {
        // Agregar un producto al hacer click en el boton
        // Revisar si el producto seleccionado ya esta e incrementarlo

        e.persist();
        this.setState({ productSelected });
        //console.log('Estado. productoSeleccionado', this.state.productSelected.nombre)
        //console.log('Argumento. productoSeleccionado', productoSeleccionado.nombre)
    ...
    handleAgregarProducto(e) {
        ...
        this.setState( {...this.state, productos: this.state.productos.concat([productSelected])} )
    }

    componentDidMount(){
        this.setState({dataSimulada: simularProductos(10)})
    }
        ...
        return (
            <div className="vender-root">
                <div className="vender-buscador">
                    <Autocomplete
                        id="combo-box-demo"
                        options={this.state.dataSimulada.productos}
                    ...
                    <div className="vender-form">
                        <label className="label-number">
                            Cantidad
                            <input type="number" className="input-number" ref={this.cantidad} />
                        </label>
                ...
                <div>
                    <TablaVentas productos={productos} />
                </div>
            </div>
        )
    }
